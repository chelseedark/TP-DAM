export class Medida{
    ...
    constructor(medida:number,fecha:Date, valor:number, dispositivoId: number){
        this._medicionId=medida;
        this._fecha=fecha;
        this._valor=valor;
        this._dispositivoId=dispositivoId;
    }
    public get medidaId():number{
        return this._medicionId
    }
    public set medidaID(valor:number){
        this._medicionId=valor;
    }
